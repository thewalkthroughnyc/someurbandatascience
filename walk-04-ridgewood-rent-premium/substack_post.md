...
a station. The question was whether I could measure it here, in Bushwick, along
the L.

I built a model to test it. And along the L, there wasn't much of one. No
reliable difference, even after controlling for the other things that move rent.

I can guess why. Bushwick is popular. A lot of people want to move here, and when
that's true, nobody has much freedom to choose how close to the L they live — you
take what you can get. So whether your walk is 5 minutes or 20, the rent doesn't
move much. That's a whole other post.

But something did turn up. The M was in the model only as a control — and it was
the M that moved. So I made it the subject instead. And even though the M is a
lackluster line compared to most, the rent difference showed up clearly: walking
away from the M-only stations clustered in Ridgewood and Middle Village, rent
falls by almost half a percent for every minute you walk. That lines up with the
theory I started with. Just not on the train I started with.

So I'm running a math walk to put it to the test.

We meet at the Seneca Ave M station and split into four teams. One walks north
toward Middle Village. One walks south toward Myrtle-Wyckoff. The other two head
east and west, away from the line entirely. Everybody predicts whether rent
rises, falls, or holds steady as they go. Then we check those predictions against
...
mind and a rough idea of what you pay in rent.

**[RSVP here.](https://luma.com/yd7jpq91)**
